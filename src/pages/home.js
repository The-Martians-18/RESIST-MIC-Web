    ...
    return (
        ...
        {imageLoaded ? (
            <div style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', height: '100vh' }}>
                ...
                <div style={{fontSize:"40px", paddingTop:'5%', paddingLeft:'45%', color:'white', textAlign:'left', paddingBottom:'20px',textShadow: '1px 1px 0 #aa647b, -1px -1px 0 #aa647b, 1px -1px 0 #aa647b, -1px 1px 0 #aa647b'}}>
                    WELCOME,
                </div>
